...
def main(args):
    ...
    cam = cv2.VideoCapture('/media/yangshun/0008EB70000B0B9F/nvidia_projects/1/1.mp4')
    ...
    while True:
        ...
        cv2.putText(im, '{:.3f}f'.format(1.0/(time.time() - t)), (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 0))
